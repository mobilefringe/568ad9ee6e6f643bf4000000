    ...
    <div class="main_container">
        ...
        <div class="row contact_row">
            <div class="col-md-6 contact_col">
                ...
                <form accept-charset="UTF-8" action="//www.mallmaverick.com/retail_users/sign_in" id="new_retail_user" method="post">
                    ...
                    <a href="//www.mallmaverick.com/retail_users/password/new" target="_blank">Forgot your password?</a>
                    <br /><br />
            ...
            <div class="col-md-6 hidden_phone">
                ...
                <p class="contact_desc">
                    <img src="//codecloud.cdn.speedyrails.net/sites/57f51d926e6f6429bc000000/image/png/1452115727000/checkmark.png" class="" alt="check mark">
